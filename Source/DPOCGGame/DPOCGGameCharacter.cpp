...
ADPOCGGameCharacter::ADPOCGGameCharacter(const FObjectInitializer& ObjectInitializer)
	...
	// intialize a motion warping component
	MotionWarpingComponent = CreateDefaultSubobject<UMotionWarpingComponent>(TEXT("MotionWarpingCom"));
...
void ADPOCGGameCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent) {
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ADPOCGGameCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ADPOCGGameCharacter::Look);
...
void ADPOCGGameCharacter::HandleClimbMovementInput(const FInputActionValue& Value) {
	...
	const FVector rightDirection = FVector::CrossProduct(
		-CustomMovementComponent->GetClimbableSurfaceNormal(), -GetActorUpVector()
	);
